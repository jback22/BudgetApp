    ...
    return (
        <TopTab.Navigator
            ...
            <TopTab.Screen
                ...
                options={{
                    ...
                    tabBarLabel: ({color, focused}) =>
                        <Text style={{color:`${focused ? '#00CD00':'#7F7F7F'}`}} >Gelirler</Text>,
            ...
            <TopTab.Screen
                ...
                options={{
                    tabBarLabel: ({color, focused}) =>
                        <Text style={{color:`${focused ? 'red':'#7F7F7F'}`}}>Giderler</Text>,
                    tabBarIcon: ({color, focused}) =>
                        <TabBarIcon
            ...
            <TopTab.Screen
                ...
                options={{
                    tabBarLabel: ({color, focused}) =>
                        <Text style={{color:`${focused ? '#F9C900':'#7F7F7F'}`}}>Alınacaklar</Text>,
                    tabBarIcon: ({color, focused}) =>
                        <TabBarIcon
                            name="ios-basket"
